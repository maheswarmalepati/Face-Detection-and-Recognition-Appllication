...
namespace PCALib
{
    ...
    public class Matrix : IMatrix
    {
		...
		*/
        ...
        public class EigenvalueDecomposition : IEigenvalueDecomposition
        {
            public int n;               // matrix dimension
            public double[] d, e;       // storage of eigenvalues.
            public Matrix V;                // storage of eigenvectors.
            public Matrix H;                // storage of nonsymmetric Hessenberg form.
            public double[] ort;        // storage for nonsymmetric algorithm.
            public double cdivr, cdivi;
            public bool isSymmetric;
